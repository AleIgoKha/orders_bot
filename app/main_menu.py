...
# ###########################
# ВСЕ УЛУЧШЕНИЯ
# 1. Шрифты и надписи все сделать живыми и реальными со смайликами и с нужной информацией
# 2. Изменение данных сессии и удаление сессии
# 3. Добавить скидку, настроить рассчет цен
...
# 5. Продумать как делать скидку. Как вариант давать выбор -  применить скидку на все товары или на отдельный товар. Выбрать величину скидки
