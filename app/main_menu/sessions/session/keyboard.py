...
session_menu = InlineKeyboardMarkup(inline_keyboard=[
    ...
    [InlineKeyboardButton(text='⚙️ Обработка заказов', callback_data='session:order_processing')],
    [InlineKeyboardButton(text='☑️ Готовые заказы', callback_data='session:completed_orders')],
    [InlineKeyboardButton(text='👌🏽 Выданные заказы', callback_data='session:issued_orders')],
    [InlineKeyboardButton(text='📈 Статистика сессии', callback_data='session:stats_menu')],
